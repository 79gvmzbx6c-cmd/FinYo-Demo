...
#    • AUTO-RUN: Simulation runs automatically on page load
#    • FIXED: Multiplicative policy boosts for realistic impact
#    • FIXED: Chart scaling to show full 0-1 FHI range
# =====================================================================
import math
